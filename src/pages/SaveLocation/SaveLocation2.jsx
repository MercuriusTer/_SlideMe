...
function SaveLocation2({ locations, addLocation, deleteLocation, setSelectPosition2 }) {
          ...
          {locations.map((location) => (
            <div key={location.id} className="buttons-container3">
              ...
              <div className="button-actions">
                <Link to={`/home/save-location2/edit-location2?id=${location.id}`}>
