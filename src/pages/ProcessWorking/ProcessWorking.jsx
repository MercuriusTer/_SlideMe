...
function ProcessWorking({ currentShowOrder }) {
  ...
  }, [location1, location2, isChatOpen]); // Re-run when locations or isChatOpen changes
  ...
  // Set up the navigation timeout
  useEffect(() => {
    const timer = setTimeout(() => {
      if (!isChatOpen) {
        navigate('/list/process-done');
      }
    }, 10000);
  ...
  if (isChatOpen) {
    return <Chat setIsChatOpen={setIsChatOpen} />;
  }
